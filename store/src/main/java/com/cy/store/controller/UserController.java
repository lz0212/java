...
public class UserController extends BaseController {
    ...
    public R find(String username) {
        return new R(true, userService.fidByUsername(username));
    }

    @GetMapping("/denglu")
    public List<User> denglu(@RequestBody User user) {
        return userService.denglu(user);
    }
